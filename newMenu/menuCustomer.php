      ...
      <div class="header_section header_bg">
         <div class="container-fluid">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               <a class="navbar-brand" href="../customer/mainpage(customer)/indexStaff.php">
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav ml-auto">
                     <li class="nav-item">
                        <a class="nav-link" href="../customer/mainpage(customer)/indexCustomer.html">Home</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="../customer/mainpage(customer)/about.html">About Us</a>
                     </li>
                     ...
                     <li class="nav-item">
                      <a class="nav-link" href="../customer/mainpage(customer)/editProfile.html">Profile</a>
                   </li>
                  </ul>
                   <!--CART-->
                  ...
                  <form class="form-inline my-2 my-lg-0">
                        <div class="login_bt">
                            <ul style="display: flex; list-style-type: none; padding: 0;">
                                <li style="margin-right: 1px; font-size: 5px;"><a href="../customer/mainpage(customer)/logout.php"><span class="user_icon"><i class="fa fa-user" aria-hidden="true"></i></span>Logout</a></li>
                            </ul>
                        </div>
                    </form>
               </div>
