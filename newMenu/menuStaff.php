      ...
      <div class="header_section">
         <div class="container-fluid">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="../staff/indexStaff.php">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="../staff/indexStaff.php">Home</a>
                        </li>
                    
                        <li class="nav-item">
                            <a class="nav-link" href="menuStaff.php">Menu</a>
                        </li>
                   
                        <li class="nav-item">
                            <a class="nav-link" href="../staff/editProfile.html">Profile</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../staff/customer.html">Customer</a>
                        </li>
                    </ul>
                    ...
                    <form class="form-inline my-2 my-lg-0">
                        <div class="login_bt">
                            <ul style="display: flex; list-style-type: none; padding: 0;">
                                <li style="margin-right: 1px; font-size: 5px;"><a href="../staff/logout.php"><span class="user_icon"><i class="fa fa-user" aria-hidden="true"></i></span>Logout</a></li>
                            </ul>
                        </div>
                    </form>
                    <!-- Cart -->
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <!-- Add Menu -->
                            <a href="addMenuStaff.php?action=add" class="btn btn-primary">Add Menu</a>
                        </div>
...
if ($customerResult->num_rows > 0) {
    while ($row = $customerResult->fetch_assoc()) {
        ...
        echo '<td>
                <a class="btn btn-primary" href="editMenuStaff.php?action=edit&id=' . $row["id"] . '">Edit</a>
                <form method="POST" action="deleteMenuStaff.php">
