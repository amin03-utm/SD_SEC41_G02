...
<body>
    <div class="container card-container">
        <div class="card">
            <div class="card-body">
                <h1 class="card-title">Order Dashboard (Staff)</h1>
                ...
                if (isset($_SESSION["user_email"])) {
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo '<td>
                                    <form action="menuViewStaff.php?user_email=' . $user_email . '" method="post">
                        ...
                        echo '<a href="../staff/indexStaff.php" class="btn btn-primary">Back to Staff Dashboard</a>';
