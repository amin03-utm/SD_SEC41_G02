      ...
      <div class="header_section header_bg">
         <div class="container-fluid">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               <a class="navbar-brand" href="../mainpage(guest)/index.html">
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav ml-auto">
                     <li class="nav-item">
                        <a class="nav-link" href="../mainpage(guest)/index.html">Home</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="../mainpage(guest)/about.html">About Us</a>
                     </li>
                     
                     <li class="nav-item">
                        <a class="nav-link" href="menuGuest.php">Menu</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="../mainpage(guest)/contact.html">Contact Us</a>
                     </li>
                  </ul>
